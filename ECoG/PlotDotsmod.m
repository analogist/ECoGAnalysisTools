function [ ] = PlotDotsmod( id, surfpath, trodeLocations, weights, holddots, viewSide, clims, markerSize, colormapName, trodeLabels, plotLabels )
%PLOTDOTSMOD Summary of this function goes here
...
%     colormap(cm);
    ...
    if(isempty(get(gcf,'Children')) || ~holddots)
        PlotCortexmod(id, surfpath, viewSide);
    end
    if(holddots && ~ishold)
        hold on;
    end
