function [highPolyPatchHandle lowPolyPatchHandle] = PlotCortexmod(id, subjDir, hemisphere,LowResHack)
    ...
    if exist('LowResHack','var')
        ...
        [highPolyPatchHandle lowPolyPatchHandle] = DoLowRes(id, subjDir, hemisphere);
        return;
    end
    %% LOW RES HACK ONLY

    highPolyModel = [subjDir '\surf\' id '_cortex_' hemisphere '_hires.mat'];
    
    lowPolyModel = [subjDir '\surf\' id '_cortex_' hemisphere '_lowres.mat'];
